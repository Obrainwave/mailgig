						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Welcome, &nbsp;<small class="text-primary"> {{ $auth->name }}</small></h1>
									<!--end::Title-->
								</div>
								<!--end::Page title-->
								<!--begin::Actions-->
										...
										<div class="card bg-primary h-md-100">
											...
											<div class="card-body d-flex flex-column pt-13 pb-14">
												...
												<div class="text-center">
													<!--begin::Link-->
													<a class="btn btn-sm btn-white btn-color-gray-800 me-2" href="{{ route('send.mail') }}">New Mail</a>
													<!--end::Link-->
													<!--begin::Link-->
													<a class="btn btn-sm bg-white btn-color-white bg-opacity-20" href="../../demo1/dist/pages/user-profile/projects.html">Sent Mails</a>
													<!--end::Link-->
												</div>
												<!--end::Links-->
											</div>
										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-body d-flex flex-column justify-content-between pb-5 px-0">
												...
												<ul class="nav nav-pills nav-pills-custom mb-3 mx-9">
													...
													<li class="nav-item mb-3 me-3 me-lg-6">
														<!--begin::Link-->
														<a class="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_3" href="#kt_charts_widget_32_tab_content_3">
															<!--begin::Icon-->
															<div class="nav-icon mb-3">
